...
$_SERVER['SCRIPT_FILENAME'] =  isset($java_scriptname) ? $java_scriptname : '';array_unshift($argv, $_SERVER['SCRIPT_FILENAME']);if (!isset($argc)) $argc = count($argv);$_SERVER['argv'] = $argv;?><?php echo 'Hello '.java_context()->get('hello').'!<br>
'; function f($v){return (string)$v+1;};?><?php java_context()->call(java_closure()); ?>