...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<%
		  ...
		  String mainatainselect=request.getParameter("maintainselect");          
										...
										<table width="100%" border="0">
											<tr>
												<td colspan="3" align="left">
													<span class="style1">Add New Data for <%out.println(dmaintain.getDataMaintainName());%></span>
												</td>
											</tr>
											<tr>
												<td colspan="3">
		  ...
		  <td colspan="2" align="left">
            <%
		      ...
		      if(inputType.equals("system")){
					...
					%> <label><input name="<%=fieldInfo.getFieldName()%>" type="text" id="Input<%=i%>" size="30" maxlength="<%=fieldInfo.getFieldLenght() %>" value="EXMxxxx" disabled /></label><%

	          }else if(inputType.equals("typing")){

                  %> <label><input name="<%=fieldInfo.getFieldName()%>" type="text" id="Input<%=i%>" size="30" maxlength="<%=fieldInfo.getFieldLenght()%>"  /></label><%  
											...
											<tr>
												...
												<td width="21%" align="left" valign="middle">
													<input name="Submit" type="button" id="Submit2"
														value="Submit" onclick="clickSubmit()" />
														 <input name="datamaintain" type="hidden" id="datamaintain"  value="<%=mainatainselect.trim()%>"  />
														 <input name="maintainevent" type="hidden" id="maintainevent"  value="adddata"  />
												</td>
