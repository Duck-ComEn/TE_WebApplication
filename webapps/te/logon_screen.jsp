              ...
              <tr>
                <td style="TEXT-ALIGN: center" valign="top" nowrap="nowrap" bgcolor="#e8eefa"><form action="logon_process.jsp" method="post" name="form1" target="_parent" id="form1">
                    <table width="100%" border="0">
                      ...
                      <tr>
                        <td width="26%" align="left">Username:
                            <label></label></td>
                      ...
                      <tr>
                        <td align="center">&nbsp;</td>
                        <td width="30%" align="left" valign="middle"><input type="submit" name="button" id="button" value="Submit" />
                      <input type="reset" name="button2" id="button2" value="Cancel" /></td>
                        <td width="44%" align="left" valign="middle"><label> </label></td>
                      </tr>
                      <tr>
                        <td colspan="3">&nbsp;</td>
                      </tr>
