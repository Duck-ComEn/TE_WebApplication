                ...
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td width="96%"><table width="100%" border="0" align="left">
                      ...
                      <p>&nbsp;</p>
                      <p>
                        <input name="EditData" type="button" id="EditData" value="Edit data" onclick="clickEdit()"/>                        
                        <input name="Cancel" type="button" id="Cancel" value="Cancel" onclick="clickCancel()" />
                      </p></td>
                    <td width="10px">&nbsp;</td>
                  </tr>
                  <tr>
		               ...
		               %> 
                         ...
                         <% 
						  for(int jj=0;jj<acvcv[0].size();jj++){						  
                                ...
                                %><td width="1%" height="1%" align="right" class="style4"><input name="editData" type="radio" value="<%=tmp%>"></td><%
...
function clickEdit(){
	...
	var alertmsg="Please select data for edit.";	
	var count=frm.editData.length;
     if(typeof count == 'undefined' ){
	  count=1;
     }
	if(count>=2){
		  for(i=0;i<count;i++){
		   if (frm.editData[i].checked==true)
		   {
			   alertmsg="";
		   }	   
		}
	}else{		
	   if (frm.editData.checked==true)
	  {
		   alertmsg="";
	   }
	}
   ...
   if(alertmsg == ""){
		frm.action = "datamaintain_edit_form.jsp";	
		frm.submit();
	}else{
		alert(alertmsg);		
	}
