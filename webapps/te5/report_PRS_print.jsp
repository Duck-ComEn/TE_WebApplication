...
dateinput=request.getParameter("dataDate");
line=request.getParameter("Line");
shift=request.getParameter("Shift");

if(request.getParameter("beginRecord")==null || request.getParameter("beginRecord").equals("")){
  	   beginRow=1;
}else{
	beginRow=Integer.parseInt(request.getParameter("beginRecord"));
}

if(request.getParameter("endRecord")==null || request.getParameter("endRecord").equals("")){
  	   endRow=1;
}else{
	endRow=Integer.parseInt(request.getParameter("endRecord"));
}

PRSReport ra=new PRSReport();		
ra.setShift_id(shift);
ra.setLine_id(line);
ra.setInputdate(dateinput);		

reportDataList=InventoryReductionManager.getReportPRSDataList(ra,beginRow,endRow); 
PRSReport segmentInfo=InventoryReductionManager.getReportPRSSegment(ra);
PRSReport pnlevelInfo=InventoryReductionManager.getReportPRSPNLevel(ra);
prsrunning=InventoryReductionManager.getReportPRSNo();
prsno=pnlevelInfo.getPart_level()+prsrunning+segmentInfo.getSegment_type();

if( (pnlevelInfo.getPart_level()==null) || (pnlevelInfo.getPart_level().equals(""))){
	String errormessage="Can't Generate PRS Report bacause PN level is empty.";
		   %>
  ...
  <tr> 
    <td height="343" valign="top"><form name="form1" method="post" action="">
        ...
        <table width="100%" border="0">
          <tr>
            <td><div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"> 
                <input name="PrintPRS" type="button" id="PrintPRS7" value="Generate PRS Report"  onClick="clickPrintPrs()">
        ...
        <table width="100%" border="0">
            ...
            <td width="11%" height="37"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#333333">
                <tr> 
                  <td height="33"><div align="center"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"> 
                      ...
                      <input type="hidden" name="dataDate" value="<%=dateinput%>">
                      <input type="hidden" name="submitflag" value="show">
                      <input name="brownum" type="hidden" value="<%=beginRow%>">
					  <input name="erownum" type="hidden" value="<%=endRow%>">
					  <input name="prsno" type="hidden" value="<%=prsno%>">
					  <input name="employeeno" type="hidden" value="<%=employeeno%>">
					  <input name="requsetername" type="hidden" value="<%=requsetername%>">
					  <input name="prsrunning" type="hidden" value="<%=prsrunning%>">
                  ...
                  <td height="59"><table width="100%" cellpadding="0" cellspacing="0" bordercolor="#000000">
                      <tr> 
                          ...
                          <table width="100%" height="75%" border="0">
                            <tr> 
                              ...
                              <td width="53%"><strong><font size="1" face="Arial, Helvetica, sans-serif"> 
                                <%out.println((new SimpleDateFormat("yyyy / MM / dd")).format(new java.util.Date().getTime()));%>
                                </font></strong></td>
                            </tr>
                            <tr> 
                              ...
                              <td><strong><font size="1" face="Arial, Helvetica, sans-serif"> 
                                <%out.println((new SimpleDateFormat("hh.mm a")).format(new java.util.Date().getTime()));%>
                                </font></strong></td>
                            </tr>
                          </table></td>
                        ...
                        <td width="33%" valign="top"><table width="100%" height="47" border="0">
                            ...
                            <tr> 
                              <td> <div align="right"><font size="1"><strong></strong></font></div></td>
                              <td><font size="1">&nbsp;</font></td>
          ...
          <tr> 
            <td height="43"><table width="100%" height="50" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr bgcolor="#333333" > 
                  ...
                  <td width="71"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong><font size="1">Invoice 
                      no </font></strong></font></div></td>
                  <td width="53"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong><font size="2"><font size="1">ID</font></font></strong></font></div></td>
                  <td width="58"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong><font size="2"><font size="1">S/N</font></font></strong></font></div></td>
                  <td width="113"><div align="center"><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"><strong><font size="2"><font size="2"><font size="1">REMARK</font></font></font></strong></font></div></td>
                </tr>
                <%
				...
				%>
                <tr> 
                  <td height="24"> <div align="center"><font face="Arial, Helvetica, sans-serif" size="1"><%=(i+1)%></font></div></td>
                  ...
                  <td height="32" align="center" valign="middle"><div align="left"> 
                      <table width="100%" border="0">
                        <tr> 
                          ...
                          <td width="32%"><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><strong><%=employeeno%> 
                              </strong> </font></div></td>
                        </tr>
                      </table>
                    </div></td>
...
function clickPrintPrs(){
  ...
  var jbrownum=frm.brownum.value;
  var jerownum=frm.erownum.value;
  var jprsno=frm.prsno.value;
  var jemployeeno=frm.employeeno.value;
  var jrequsetername=frm.requsetername.value;
  var jprsrunning=frm.prsrunning.value;
  
  alertmsg=alertmsg+IsEmpty(jdataDate,"Date");
  ...
  alertmsg=alertmsg+IsEmpty(jrequsetername,"Requseter Name");
  alertmsg=alertmsg+IsEmpty(jprsrunning,"PRS Running No");
  alertmsg=alertmsg+IsNumeric(jprsrunning,"PRS Running No");  

  alertmsg=alertmsg+IsEmpty(jbrownum,"jbrownum");
  alertmsg=alertmsg+IsNumeric(jbrownum,"jbrownum");

   alertmsg=alertmsg+IsEmpty(jerownum,"jerownum");
   alertmsg=alertmsg+IsNumeric(jerownum,"jerownum");

  if(alertmsg == ""){
	  frm.PrintPRS.style.visibility='hidden';
	  frm.cancel.style.visibility='hidden';
	  if(confirm("Do you want to print PRS Report?")){
			window.print();
		}	
	  
	  frm.action="report_prs_process.jsp";	
	  frm.submit();		
				
  }else{	    
		alert("The Parameters are incorrect , Please verify your parameters and try again.");
  }	
