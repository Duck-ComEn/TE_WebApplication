...
<%
          	          	          	          	String pUserID = "Error";
          	          	          	          	String pPassword = "Error";
												...
												UserManagerPortType service = client.getUserManagerHttpPort();	
          	          	          	          	...
          	          	          	          	JAXBElement<String> x1 = (JAXBElement<String>)user.getUserID();
                                        		pUserID =x1.getValue();
                                        		
                                        
          	          	          	          	
          	          	          	          	JAXBElement<String> x2 = (JAXBElement<String>)user.getPassword();
                                        		pPassword =x2.getValue();
            ...
            <tbody>
              <tr>
                <td style="TEXT-ALIGN: center" valign="top" nowrap="nowrap" bgcolor="#e8eefa"><form action="logon_process.jsp" method="post" name="form1" target="_parent" id="form1">
                    <table width="100%" border="0">
                      <tr>
                        <td colspan="3" align="left"><span class="style1">Register Confirmation </span></td>
                      </tr>
                      <tr>
                        <td colspan="3">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="23%" align="left"><span class="style2">User Name:</span>                          <label></label></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left"><%out.println(pPassword); %></td>
                      </tr>
                      <tr>
